 ...
 */
// define( 'CIVICRM_UF_DSN'           , 'mysql://drupal_wis_stg:9Sdjfsdq2XhURq9v@localhost/drupal_wis_staging?new_link=true' );
define( 'CIVICRM_UF_DSN'           , 'mysql://root:root@localhost/wis?new_link=true' );
 ...
 *
 */
// define( 'CIVICRM_DSN'          , 'mysql://drupal_wis_stg:9Sdjfsdq2XhURq9v@localhost/drupal_wis_staging?new_link=true' );
define( 'CIVICRM_DSN'          , 'mysql://root:root@localhost/wis?new_link=true' );
...
$civicrm_root = '/Sites/duke/wis/sites/all/modules/civicrm';
// define( 'CIVICRM_TEMPLATE_COMPILEDIR', '/var/www/wis-staging/sites/default/files/civicrm/templates_c/' );
define( 'CIVICRM_TEMPLATE_COMPILEDIR', '/Sites/duke/wis/sites/default/files/civicrm/templates_c/' );
 ...
 *
 */
// define( 'CIVICRM_UF_BASEURL'      , 'http://women-in-stats.org/' );
define( 'CIVICRM_UF_BASEURL'      , 'http://localhost/duke/wis/' );
 ...
 */
define( 'CIVICRM_SITE_KEY', '49b12ae719c6933544f59921c78306a1' );
 ...
 */
// define( 'CIVICRM_MAIL_LOG', '/var/www/wis-dev/sites/default/files/civicrm/templates_c//mail.log' );
